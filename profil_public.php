...
<html lang="fr">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo dirname($_SERVER['SCRIPT_NAME'])?>/styles/style.css">
    </head>
    <body>
        <?php
        ...
        <main>
            <?php 
                ...
                $login_profil = $_GET['login'];
                $info_user = info_user($mysqli, $login_profil);
                affiche_profil_public($info_user); 
            ?>
        </main>
        <?php
